...
public class WeatherController {
    ...
    @GetMapping("/forecast")
    public CommonResponse<WeatherInfo> getShortTermForecast(
            @RequestParam("nx") String nx,
            @RequestParam("ny") String ny
    ) {
        WeatherInfo weatherInfo = weatherService.getShortTermForecast(nx, ny);
        return CommonResponse.success(weatherInfo);
    }
}
